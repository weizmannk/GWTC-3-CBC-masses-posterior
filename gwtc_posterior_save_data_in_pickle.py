...
with tqdm(total=len(BNS)) as progress:
    for gw_name in BNS:
        ...
        table_masses[gw_name] = {}
        table_masses[gw_name]['mass1']= list(posterior_samples['IMRPhenomPv2NRT_highSpin_posterior']['m1_detector_frame_Msun'])
        table_masses[gw_name]['mass2']= list(posterior_samples['IMRPhenomPv2NRT_highSpin_posterior']['m2_detector_frame_Msun'])
